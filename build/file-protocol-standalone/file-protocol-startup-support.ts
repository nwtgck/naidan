...
export function createFileProtocolStandaloneEntryBootstrapSource({ entryFileName, slowStartupNoticeDelayMs = 15_000 }: Readonly<{entryFileName: string; slowStartupNoticeDelayMs?: number}>): string {
      ...
      setTimeout(function () {
        ...
        var panelShownAt = appElement && appElement.childElementCount > 0
          ...
          : debugRenderPanel(
            ...
            'Startup has remained at checkpoint "' + stalledCheckpoint + '" for ${slowStartupNoticeDelayMs} ms.'
          );
        debugState.slowStartupNotice = {
          delayMs: ${slowStartupNoticeDelayMs},
...
export function createSystemJsFileScriptLoaderPatchSource() {
...
export function createSystemJsPhysicalLoadRecoverySource() {
