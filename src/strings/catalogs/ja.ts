...
import { AssistantProcessSequence__and_more } from '@/strings/messages/AssistantProcessSequence__and_more/ja';
...
import { AssistantProcessSequence__thinking_steps } from '@/strings/messages/AssistantProcessSequence__thinking_steps/ja';
import { AssistantProcessSequence__tool_executions } from '@/strings/messages/AssistantProcessSequence__tool_executions/ja';
import { AssistantProcessSequence__used_tools } from '@/strings/messages/AssistantProcessSequence__used_tools/ja';
...
import { ChatDebugInspector__copy_json } from '@/strings/messages/ChatDebugInspector__copy_json/ja';
import { ChatDebugInspector__current_thread } from '@/strings/messages/ChatDebugInspector__current_thread/ja';
...
import { ChatDebugInspector__failed_to_parse_image_metadata_during_preview_collection } from '@/strings/messages/ChatDebugInspector__failed_to_parse_image_metadata_during_preview_collection/ja';
...
import { ChatDebugInspector__json } from '@/strings/messages/ChatDebugInspector__json/ja';
...
import { ChatMediaShelf__failed_to_embed_metadata_in_image } from '@/strings/messages/ChatMediaShelf__failed_to_embed_metadata_in_image/ja';
...
import { ChatPane__chat } from '@/strings/messages/ChatPane__chat/ja';
...
import { DebugPanel__application_state_synchronized } from '@/strings/messages/DebugPanel__application_state_synchronized/ja';
...
import { DebugPanel__intentional_test_error_triggered_by_user } from '@/strings/messages/DebugPanel__intentional_test_error_triggered_by_user/ja';
...
import { DebugPanel__this_is_used_to_verify_the_error_event_system_ui } from '@/strings/messages/DebugPanel__this_is_used_to_verify_the_error_event_system_ui/ja';
...
import { OnboardingModal__connection_attempt_cancelled } from '@/strings/messages/OnboardingModal__connection_attempt_cancelled/ja';
...
import { ToolConfigHierarchySettings__turn_off_tool } from '@/strings/messages/ToolConfigHierarchySettings__turn_off_tool/ja';
import { ToolConfigHierarchySettings__turn_on_tool } from '@/strings/messages/ToolConfigHierarchySettings__turn_on_tool/ja';
...
import { ModelSupportInvestigationModal__download_partial_evidence } from '@/strings/messages/ModelSupportInvestigationModal__download_partial_evidence/ja';
...
import { ModelSupportInvestigationModal__this_is_partial_evidence } from '@/strings/messages/ModelSupportInvestigationModal__this_is_partial_evidence/ja';
...
import { blockMarkdown__failed_to_embed_metadata_in_image } from '@/strings/messages/blockMarkdown__failed_to_embed_metadata_in_image/ja';
...
import { fileExplorer__creating_archive } from '@/strings/messages/fileExplorer__creating_archive/ja';
...
import { fileExplorer__download_directory } from '@/strings/messages/fileExplorer__download_directory/ja';
...
import { fileExplorer__folder_is_no_longer_available } from '@/strings/messages/fileExplorer__folder_is_no_longer_available/ja';
...
import { fileExplorer__place_directory_itself_description } from '@/strings/messages/fileExplorer__place_directory_itself_description/ja';
import { fileExplorer__place_zip_file_as_is } from '@/strings/messages/fileExplorer__place_zip_file_as_is/ja';
import { fileExplorer__place_zip_file_as_is_description } from '@/strings/messages/fileExplorer__place_zip_file_as_is_description/ja';
import { fileExplorer__placement_method } from '@/strings/messages/fileExplorer__placement_method/ja';
import { fileExplorer__placement_preview } from '@/strings/messages/fileExplorer__placement_preview/ja';
...
import { usePrompt__prompt } from '@/strings/messages/usePrompt__prompt/ja';
...
import { OpfsEncryptionSettingsPanel__additional_conflicting_entries } from '@/strings/messages/OpfsEncryptionSettingsPanel__additional_conflicting_entries/ja';
import { OpfsEncryptionSettingsPanel__conflict_changed } from '@/strings/messages/OpfsEncryptionSettingsPanel__conflict_changed/ja';
import { OpfsEncryptionSettingsPanel__delete_conflicting_data_and_retry } from '@/strings/messages/OpfsEncryptionSettingsPanel__delete_conflicting_data_and_retry/ja';
import { OpfsEncryptionSettingsPanel__encrypted_source_remains_authoritative } from '@/strings/messages/OpfsEncryptionSettingsPanel__encrypted_source_remains_authoritative/ja';
import { OpfsEncryptionSettingsPanel__plain_target_conflict } from '@/strings/messages/OpfsEncryptionSettingsPanel__plain_target_conflict/ja';
import { OpfsEncryptionSettingsPanel__plain_target_conflict_explanation } from '@/strings/messages/OpfsEncryptionSettingsPanel__plain_target_conflict_explanation/ja';
import { OpfsEncryptionSettingsPanel__plain_target_conflict_loss_warning } from '@/strings/messages/OpfsEncryptionSettingsPanel__plain_target_conflict_loss_warning/ja';
import { opfsEncryption__build_and_verify_separate_encrypted_store } from '@/strings/messages/opfsEncryption__build_and_verify_separate_encrypted_store/ja';
import { opfsEncryption__cancel } from '@/strings/messages/opfsEncryption__cancel/ja';
import { opfsEncryption__change_opfs_passphrase } from '@/strings/messages/opfsEncryption__change_opfs_passphrase/ja';
import { opfsEncryption__change_passphrase } from '@/strings/messages/opfsEncryption__change_passphrase/ja';
...
import { opfsEncryption__copy_source } from '@/strings/messages/opfsEncryption__copy_source/ja';
...
import { opfsEncryption__decrypt_storage_explanation } from '@/strings/messages/opfsEncryption__decrypt_storage_explanation/ja';
import { opfsEncryption__enable_opfs_encryption } from '@/strings/messages/opfsEncryption__enable_opfs_encryption/ja';
...
import { opfsEncryption__experimental } from '@/strings/messages/opfsEncryption__experimental/ja';
import { opfsEncryption__experimental_format_may_change_incompatibly } from '@/strings/messages/opfsEncryption__experimental_format_may_change_incompatibly/ja';
import { opfsEncryption__hide_passphrase } from '@/strings/messages/opfsEncryption__hide_passphrase/ja';
import { opfsEncryption__interrupted_encryption_operation } from '@/strings/messages/opfsEncryption__interrupted_encryption_operation/ja';
import { opfsEncryption__leading_or_trailing_whitespace_is_part_of_passphrase } from '@/strings/messages/opfsEncryption__leading_or_trailing_whitespace_is_part_of_passphrase/ja';
import { opfsEncryption__loading_recovery_source } from '@/strings/messages/opfsEncryption__loading_recovery_source/ja';
import { opfsEncryption__new_passphrase } from '@/strings/messages/opfsEncryption__new_passphrase/ja';
import { opfsEncryption__only_passphrase_keyslot_is_replaced } from '@/strings/messages/opfsEncryption__only_passphrase_keyslot_is_replaced/ja';
import { opfsEncryption__open_raw_opfs_explorer } from '@/strings/messages/opfsEncryption__open_raw_opfs_explorer/ja';
import { opfsEncryption__opfs_encryption } from '@/strings/messages/opfsEncryption__opfs_encryption/ja';
import { opfsEncryption__passphrase } from '@/strings/messages/opfsEncryption__passphrase/ja';
import { opfsEncryption__passphrases_cannot_contain_line_breaks } from '@/strings/messages/opfsEncryption__passphrases_cannot_contain_line_breaks/ja';
import { opfsEncryption__passphrases_do_not_match } from '@/strings/messages/opfsEncryption__passphrases_do_not_match/ja';
import { opfsEncryption__naidan_could_not_finish_loading } from '@/strings/messages/opfsEncryption__naidan_could_not_finish_loading/ja';
import { opfsEncryption__preparing_naidan } from '@/strings/messages/opfsEncryption__preparing_naidan/ja';
import { opfsEncryption__raw_opfs_access_does_not_decrypt } from '@/strings/messages/opfsEncryption__raw_opfs_access_does_not_decrypt/ja';
import { opfsEncryption__re_encrypt } from '@/strings/messages/opfsEncryption__re_encrypt/ja';
import { opfsEncryption__re_encrypt_opfs_storage } from '@/strings/messages/opfsEncryption__re_encrypt_opfs_storage/ja';
...
import { opfsEncryption__storage_unlocked_but_naidan_could_not_finish_loading } from '@/strings/messages/opfsEncryption__storage_unlocked_but_naidan_could_not_finish_loading/ja';
import { opfsEncryption__storage_unlocked_preparing_application } from '@/strings/messages/opfsEncryption__storage_unlocked_preparing_application/ja';
...
import { opfsEncryption__updating_encrypted_storage } from '@/strings/messages/opfsEncryption__updating_encrypted_storage/ja';
...
import { volumes__name_cannot_be_empty } from '@/strings/messages/volumes__name_cannot_be_empty/ja';
...
import { weshTerminal__session } from '@/strings/messages/weshTerminal__session/ja';
