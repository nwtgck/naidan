...
import { AboutTab__a_privacy_focused_lm_interface_for_local_use_designed_to_run_directly_from_a_portable_directory } from '@/strings/messages/AboutTab__a_privacy_focused_lm_interface_for_local_use_designed_to_run_directly_from_a_portable_directory/ja';
...
import { AboutTab__naidan_is_built_with_incredible_open_source_software_we_are_grateful_to_the_community_for_their_contributions } from '@/strings/messages/AboutTab__naidan_is_built_with_incredible_open_source_software_we_are_grateful_to_the_community_for_their_contributions/ja';
...
import { ChatInput__remove_the_copied_folder_from_this_chat_the_copy_stored_in_the_browser_will_be_deleted } from '@/strings/messages/ChatInput__remove_the_copied_folder_from_this_chat_the_copy_stored_in_the_browser_will_be_deleted/ja';
import { ChatInput__stop_using_this_folder_in_this_chat_your_original_files_on_disk_stay_safe_and_intact } from '@/strings/messages/ChatInput__stop_using_this_folder_in_this_chat_your_original_files_on_disk_stay_safe_and_intact/ja';
...
import { GlobalToolsSettings__set_the_defaults_for_every_chat_chat_groups_and_individual_chats_can_override_each_tool_independently } from '@/strings/messages/GlobalToolsSettings__set_the_defaults_for_every_chat_chat_groups_and_individual_chats_can_override_each_tool_independently/ja';
...
import { ProviderProfilesTab__save_and_switch_between_different_ai_provider_configurations_easily } from '@/strings/messages/ProviderProfilesTab__save_and_switch_between_different_ai_provider_configurations_easily/ja';
...
import { RecipeImportTab__import_predefined_chat_group_settings_prompts_parameters_and_model_rules_from_json } from '@/strings/messages/RecipeImportTab__import_predefined_chat_group_settings_prompts_parameters_and_model_rules_from_json/ja';
...
import { RecipeImportTab__no_valid_recipes_found_in_input } from '@/strings/messages/RecipeImportTab__no_valid_recipes_found_in_input/ja';
import { RecipeImportTab__parse_error } from '@/strings/messages/RecipeImportTab__parse_error/ja';
...
import { RecipeImportTab__validation_error } from '@/strings/messages/RecipeImportTab__validation_error/ja';
...
import { SettingsModal__no_valid_recipes_found_in_input } from '@/strings/messages/SettingsModal__no_valid_recipes_found_in_input/ja';
import { SettingsModal__parse_error } from '@/strings/messages/SettingsModal__parse_error/ja';
...
import { SettingsModal__validation_error } from '@/strings/messages/SettingsModal__validation_error/ja';
...
export const ja = {
  AboutTab__a_privacy_focused_lm_interface_for_local_use_designed_to_run_directly_from_a_portable_directory,
  AboutTab__about_naidan,
  AboutTab__github_repository,
  AboutTab__loading_licenses,
  AboutTab__naidan_is_built_with_incredible_open_source_software_we_are_grateful_to_the_community_for_their_contributions,
  ...
  ChatInput__remove_the_copied_folder_from_this_chat_the_copy_stored_in_the_browser_will_be_deleted,
  ChatInput__stop_using_this_folder_in_this_chat_your_original_files_on_disk_stay_safe_and_intact,
  ChatInput__type_a_message,
  ChatInput__unlink,
  ChatInput__unlink_folder,
  GlobalToolsSettings__global_settings,
  GlobalToolsSettings__set_the_defaults_for_every_chat_chat_groups_and_individual_chats_can_override_each_tool_independently,
  ...
  ProviderProfilesTab__save_and_switch_between_different_ai_provider_configurations_easily,
  ...
  RecipeImportTab__import_predefined_chat_group_settings_prompts_parameters_and_model_rules_from_json,
