...
import { ChatDebugInspector__copy_json } from '@/strings/messages/ChatDebugInspector__copy_json/ko';
import { ChatDebugInspector__current_thread } from '@/strings/messages/ChatDebugInspector__current_thread/ko';
...
import { ChatDebugInspector__json } from '@/strings/messages/ChatDebugInspector__json/ko';
...
import { OpfsEncryptionSettingsPanel__additional_conflicting_entries } from '@/strings/messages/OpfsEncryptionSettingsPanel__additional_conflicting_entries/ko';
import { OpfsEncryptionSettingsPanel__conflict_changed } from '@/strings/messages/OpfsEncryptionSettingsPanel__conflict_changed/ko';
import { OpfsEncryptionSettingsPanel__delete_conflicting_data_and_retry } from '@/strings/messages/OpfsEncryptionSettingsPanel__delete_conflicting_data_and_retry/ko';
import { OpfsEncryptionSettingsPanel__encrypted_source_remains_authoritative } from '@/strings/messages/OpfsEncryptionSettingsPanel__encrypted_source_remains_authoritative/ko';
import { OpfsEncryptionSettingsPanel__plain_target_conflict } from '@/strings/messages/OpfsEncryptionSettingsPanel__plain_target_conflict/ko';
import { OpfsEncryptionSettingsPanel__plain_target_conflict_explanation } from '@/strings/messages/OpfsEncryptionSettingsPanel__plain_target_conflict_explanation/ko';
import { OpfsEncryptionSettingsPanel__plain_target_conflict_loss_warning } from '@/strings/messages/OpfsEncryptionSettingsPanel__plain_target_conflict_loss_warning/ko';
import { opfsEncryption__build_and_verify_separate_encrypted_store } from '@/strings/messages/opfsEncryption__build_and_verify_separate_encrypted_store/ko';
import { opfsEncryption__cancel } from '@/strings/messages/opfsEncryption__cancel/ko';
import { opfsEncryption__change_opfs_passphrase } from '@/strings/messages/opfsEncryption__change_opfs_passphrase/ko';
import { opfsEncryption__change_passphrase } from '@/strings/messages/opfsEncryption__change_passphrase/ko';
import { opfsEncryption__changing_raw_opfs_during_transition_can_prevent_recovery } from '@/strings/messages/opfsEncryption__changing_raw_opfs_during_transition_can_prevent_recovery/ko';
import { opfsEncryption__confirm_new_passphrase } from '@/strings/messages/opfsEncryption__confirm_new_passphrase/ko';
import { opfsEncryption__confirm_passphrase } from '@/strings/messages/opfsEncryption__confirm_passphrase/ko';
import { opfsEncryption__copied } from '@/strings/messages/opfsEncryption__copied/ko';
import { opfsEncryption__copy } from '@/strings/messages/opfsEncryption__copy/ko';
import { opfsEncryption__copy_source } from '@/strings/messages/opfsEncryption__copy_source/ko';
import { opfsEncryption__copying_and_verifying_complete_opfs_storage } from '@/strings/messages/opfsEncryption__copying_and_verifying_complete_opfs_storage/ko';
import { opfsEncryption__could_not_read_encryption_control_state } from '@/strings/messages/opfsEncryption__could_not_read_encryption_control_state/ko';
import { opfsEncryption__decrypt_storage } from '@/strings/messages/opfsEncryption__decrypt_storage/ko';
import { opfsEncryption__decrypt_storage_explanation } from '@/strings/messages/opfsEncryption__decrypt_storage_explanation/ko';
import { opfsEncryption__enable_opfs_encryption } from '@/strings/messages/opfsEncryption__enable_opfs_encryption/ko';
import { opfsEncryption__encrypt_storage } from '@/strings/messages/opfsEncryption__encrypt_storage/ko';
import { opfsEncryption__encrypted_storage_needs_recovery } from '@/strings/messages/opfsEncryption__encrypted_storage_needs_recovery/ko';
import { opfsEncryption__encryption_control_state_cannot_be_read_safely } from '@/strings/messages/opfsEncryption__encryption_control_state_cannot_be_read_safely/ko';
import { opfsEncryption__encryption_enabled } from '@/strings/messages/opfsEncryption__encryption_enabled/ko';
import { opfsEncryption__encryption_state_is_unreadable } from '@/strings/messages/opfsEncryption__encryption_state_is_unreadable/ko';
import { opfsEncryption__encryption_transition_must_finish_before_changing_this_setting } from '@/strings/messages/opfsEncryption__encryption_transition_must_finish_before_changing_this_setting/ko';
import { opfsEncryption__enter_passphrase_for_opfs_storage } from '@/strings/messages/opfsEncryption__enter_passphrase_for_opfs_storage/ko';
import { opfsEncryption__experimental } from '@/strings/messages/opfsEncryption__experimental/ko';
import { opfsEncryption__experimental_format_may_change_incompatibly } from '@/strings/messages/opfsEncryption__experimental_format_may_change_incompatibly/ko';
import { opfsEncryption__hide_passphrase } from '@/strings/messages/opfsEncryption__hide_passphrase/ko';
import { opfsEncryption__interrupted_encryption_operation } from '@/strings/messages/opfsEncryption__interrupted_encryption_operation/ko';
import { opfsEncryption__leading_or_trailing_whitespace_is_part_of_passphrase } from '@/strings/messages/opfsEncryption__leading_or_trailing_whitespace_is_part_of_passphrase/ko';
import { opfsEncryption__loading_recovery_source } from '@/strings/messages/opfsEncryption__loading_recovery_source/ko';
import { opfsEncryption__new_passphrase } from '@/strings/messages/opfsEncryption__new_passphrase/ko';
import { opfsEncryption__only_passphrase_keyslot_is_replaced } from '@/strings/messages/opfsEncryption__only_passphrase_keyslot_is_replaced/ko';
import { opfsEncryption__open_raw_opfs_explorer } from '@/strings/messages/opfsEncryption__open_raw_opfs_explorer/ko';
import { opfsEncryption__opfs_encryption } from '@/strings/messages/opfsEncryption__opfs_encryption/ko';
import { opfsEncryption__passphrase } from '@/strings/messages/opfsEncryption__passphrase/ko';
import { opfsEncryption__passphrases_cannot_contain_line_breaks } from '@/strings/messages/opfsEncryption__passphrases_cannot_contain_line_breaks/ko';
import { opfsEncryption__passphrases_do_not_match } from '@/strings/messages/opfsEncryption__passphrases_do_not_match/ko';
import { opfsEncryption__naidan_could_not_finish_loading } from '@/strings/messages/opfsEncryption__naidan_could_not_finish_loading/ko';
import { opfsEncryption__preparing_naidan } from '@/strings/messages/opfsEncryption__preparing_naidan/ko';
import { opfsEncryption__raw_opfs_access_does_not_decrypt } from '@/strings/messages/opfsEncryption__raw_opfs_access_does_not_decrypt/ko';
import { opfsEncryption__re_encrypt } from '@/strings/messages/opfsEncryption__re_encrypt/ko';
import { opfsEncryption__re_encrypt_opfs_storage } from '@/strings/messages/opfsEncryption__re_encrypt_opfs_storage/ko';
import { opfsEncryption__re_encrypt_storage } from '@/strings/messages/opfsEncryption__re_encrypt_storage/ko';
import { opfsEncryption__re_encrypt_storage_explanation } from '@/strings/messages/opfsEncryption__re_encrypt_storage_explanation/ko';
import { opfsEncryption__recovery_source } from '@/strings/messages/opfsEncryption__recovery_source/ko';
import { opfsEncryption__resolve_interrupted_opfs_decryption } from '@/strings/messages/opfsEncryption__resolve_interrupted_opfs_decryption/ko';
import { opfsEncryption__resolve_interrupted_opfs_encryption } from '@/strings/messages/opfsEncryption__resolve_interrupted_opfs_encryption/ko';
import { opfsEncryption__resolve_interrupted_opfs_reencryption } from '@/strings/messages/opfsEncryption__resolve_interrupted_opfs_reencryption/ko';
import { opfsEncryption__retry_after_recovery } from '@/strings/messages/opfsEncryption__retry_after_recovery/ko';
import { opfsEncryption__save_file } from '@/strings/messages/opfsEncryption__save_file/ko';
import { opfsEncryption__save_source } from '@/strings/messages/opfsEncryption__save_source/ko';
import { opfsEncryption__select_opfs_as_active_storage_to_enable_encryption } from '@/strings/messages/opfsEncryption__select_opfs_as_active_storage_to_enable_encryption/ko';
import { opfsEncryption__show_passphrase } from '@/strings/messages/opfsEncryption__show_passphrase/ko';
import { opfsEncryption__source_remains_until_verified } from '@/strings/messages/opfsEncryption__source_remains_until_verified/ko';
import { opfsEncryption__storage_unlocked_but_naidan_could_not_finish_loading } from '@/strings/messages/opfsEncryption__storage_unlocked_but_naidan_could_not_finish_loading/ko';
import { opfsEncryption__storage_unlocked_preparing_application } from '@/strings/messages/opfsEncryption__storage_unlocked_preparing_application/ko';
import { opfsEncryption__transparently_encrypt_naidan_opfs_data } from '@/strings/messages/opfsEncryption__transparently_encrypt_naidan_opfs_data/ko';
import { opfsEncryption__turn_off_opfs_encryption } from '@/strings/messages/opfsEncryption__turn_off_opfs_encryption/ko';
import { opfsEncryption__understand_experimental_storage_risk } from '@/strings/messages/opfsEncryption__understand_experimental_storage_risk/ko';
import { opfsEncryption__unlock_and_resolve } from '@/strings/messages/opfsEncryption__unlock_and_resolve/ko';
import { opfsEncryption__unlock_encrypted_storage } from '@/strings/messages/opfsEncryption__unlock_encrypted_storage/ko';
import { opfsEncryption__unlock_storage } from '@/strings/messages/opfsEncryption__unlock_storage/ko';
import { opfsEncryption__unlocked } from '@/strings/messages/opfsEncryption__unlocked/ko';
import { opfsEncryption__updating_encrypted_storage } from '@/strings/messages/opfsEncryption__updating_encrypted_storage/ko';
import { DeveloperOpfsEncryptionInterruptionPanel__after_authority_switch } from '@/strings/messages/DeveloperOpfsEncryptionInterruptionPanel__after_authority_switch/ko';
import { DeveloperOpfsEncryptionInterruptionPanel__before_authority_switch } from '@/strings/messages/DeveloperOpfsEncryptionInterruptionPanel__before_authority_switch/ko';
import { DeveloperOpfsEncryptionInterruptionPanel__confirm_passphrase } from '@/strings/messages/DeveloperOpfsEncryptionInterruptionPanel__confirm_passphrase/ko';
import { DeveloperOpfsEncryptionInterruptionPanel__interrupt_and_reload } from '@/strings/messages/DeveloperOpfsEncryptionInterruptionPanel__interrupt_and_reload/ko';
import { DeveloperOpfsEncryptionInterruptionPanel__interrupt_opfs_transition } from '@/strings/messages/DeveloperOpfsEncryptionInterruptionPanel__interrupt_opfs_transition/ko';
import { DeveloperOpfsEncryptionInterruptionPanel__interruption_boundary } from '@/strings/messages/DeveloperOpfsEncryptionInterruptionPanel__interruption_boundary/ko';
import { DeveloperOpfsEncryptionInterruptionPanel__interrupts_ordinary_transition } from '@/strings/messages/DeveloperOpfsEncryptionInterruptionPanel__interrupts_ordinary_transition/ko';
import { DeveloperOpfsEncryptionInterruptionPanel__operation } from '@/strings/messages/DeveloperOpfsEncryptionInterruptionPanel__operation/ko';
import { DeveloperOpfsEncryptionInterruptionPanel__opfs_only } from '@/strings/messages/DeveloperOpfsEncryptionInterruptionPanel__opfs_only/ko';
import { DeveloperOpfsEncryptionInterruptionPanel__opfs_transition_interruption } from '@/strings/messages/DeveloperOpfsEncryptionInterruptionPanel__opfs_transition_interruption/ko';
import { DeveloperOpfsEncryptionInterruptionPanel__ordinary_transition_warning } from '@/strings/messages/DeveloperOpfsEncryptionInterruptionPanel__ordinary_transition_warning/ko';
import { DeveloperOpfsEncryptionInterruptionPanel__transition_in_progress } from '@/strings/messages/DeveloperOpfsEncryptionInterruptionPanel__transition_in_progress/ko';
import { opfsEncryption__progress_bytes } from '@/strings/messages/opfsEncryption__progress_bytes/ko';
import { opfsEncryption__progress_cleaning_source } from '@/strings/messages/opfsEncryption__progress_cleaning_source/ko';
import { opfsEncryption__progress_copying } from '@/strings/messages/opfsEncryption__progress_copying/ko';
import { opfsEncryption__progress_entries } from '@/strings/messages/opfsEncryption__progress_entries/ko';
import { opfsEncryption__progress_finalizing } from '@/strings/messages/opfsEncryption__progress_finalizing/ko';
import { opfsEncryption__progress_preparing } from '@/strings/messages/opfsEncryption__progress_preparing/ko';
import { opfsEncryption__progress_switching_authority } from '@/strings/messages/opfsEncryption__progress_switching_authority/ko';
import { opfsEncryption__progress_verifying } from '@/strings/messages/opfsEncryption__progress_verifying/ko';
import { opfsEncryption__return_to_plain_after_authority_switch } from '@/strings/messages/opfsEncryption__return_to_plain_after_authority_switch/ko';
import { opfsEncryption__return_to_plain_before_authority_switch } from '@/strings/messages/opfsEncryption__return_to_plain_before_authority_switch/ko';
import { opfsEncryption__stop_encryption_and_return_to_plain } from '@/strings/messages/opfsEncryption__stop_encryption_and_return_to_plain/ko';
import { opfsEncryption__returning_to_plain_storage } from '@/strings/messages/opfsEncryption__returning_to_plain_storage/ko';
