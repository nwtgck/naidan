import { z } from 'zod';
import type { FakeLmLanguage } from '@/services/fake-lm/core/markdownTypes';
import type { TextPattern } from '@/services/fake-lm/core/textPattern';
import type { WeightedValue } from '@/services/fake-lm/core/weighted';
...
const fakeLmLanguageJsonLoaders = {
  ja: () => import('@/services/fake-lm/languages/ja'),
  en: () => import('@/services/fake-lm/languages/en'),
