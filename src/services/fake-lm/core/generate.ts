import { createEmptyFakeLmInputAnalysis } from '@/services/fake-lm/core/inputAnalysis';
import { streamFakeLmMarkdown, type StreamFakeLmMarkdownInput } from '@/services/fake-lm/core/stream';
