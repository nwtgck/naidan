...
export const cpCommandDefinition: WeshCommandDefinition = {
  ...
  fn: async ({ context }: { context: WeshCommandContext }): Promise<WeshCommandResult> => {
    ...
    const parsed = parseStandardArgv({
      ...
      spec: {
        options: [
          { kind: 'flag', short: 'R', long: 'recursive', effects: [{ key: 'recursive', value: true }] },
          { kind: 'flag', short: 'r', long: 'r', effects: [{ key: 'recursive', value: true }] },
          {
            kind: 'flag',
            short: 'a',
            long: 'archive',
          ...
          { kind: 'flag', short: 'L', long: 'dereference', effects: [{ key: 'symlinkMode', value: 'logical' }] },
          { kind: 'flag', short: 'P', long: 'no-dereference', effects: [{ key: 'symlinkMode', value: 'physical' }] },
          ...
          { kind: 'flag', short: 'n', long: 'no-clobber', effects: [{ key: 'noClobber', value: true }] },
          {
            kind: 'value',
            short: 't',
