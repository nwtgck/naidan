...
export const lsCommandDefinition: WeshCommandDefinition = {
  ...
  fn: async ({ context }: { context: WeshCommandContext }): Promise<WeshCommandResult> => {
    const parsed = parseStandardArgv({
      ...
      spec: {
        options: [
          { kind: 'flag', short: 'l', long: 'l', effects: [{ key: 'l', value: true }] },
          { kind: 'flag', short: 'a', long: 'a', effects: [{ key: 'a', value: true }] },
          { kind: 'flag', short: 'R', long: 'R', effects: [{ key: 'R', value: true }] },
          { kind: 'flag', short: '1', long: '1', effects: [{ key: '1', value: true }] },
          { kind: 'flag', short: 'h', long: 'h', effects: [{ key: 'h', value: true }] },
          { kind: 'flag', short: 'L', long: undefined, effects: [{ key: 'symlinkMode', value: 'logical' }] },
          { kind: 'flag', short: 'H', long: undefined, effects: [{ key: 'symlinkMode', value: 'command-line' }] },
          { kind: 'flag', short: 'P', long: undefined, effects: [{ key: 'symlinkMode', value: 'physical' }] },
        ],
