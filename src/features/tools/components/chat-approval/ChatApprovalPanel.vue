...
import type { ApprovalActionId, ApprovalActiveRequest, ApprovalUiDecision } from '@/features/tools/approval';
...
<template>
  <div
    tw-class="rounded-2xl border border-gray-100 bg-white p-3 shadow-lg ring-1 ring-black/5 dark:border-gray-700 dark:bg-gray-800 dark:ring-white/10"
    data-testid="chat-approval-panel"
  >
    <div tw-class="flex flex-col gap-2.5">
      <div tw-class="min-w-0">
        <div tw-class="truncate text-sm font-semibold text-gray-900 dark:text-gray-100">
          {{ approvalTitle }}
        </div>
      </div>
      ...
      <div
        ...
        tw-class="rounded-xl border border-gray-100 bg-gray-50/80 px-3 py-2 dark:border-gray-700 dark:bg-gray-900/40"
      >
