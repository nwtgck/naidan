import type { LoadedLexicons } from '@/features/fake-lm/core/lexiconLoader';
import type { FakeLmInputAnalysis } from '@/features/fake-lm/core/inputAnalysis';
import type { FakeLmLanguage, FakeLmMode, Inline } from '@/features/fake-lm/core/markdownTypes';
import type { FakeLmSeed, SeededNonCryptoPseudoRandom } from '@/features/fake-lm/core/random';
import type { PatternHistory } from '@/features/fake-lm/core/textPattern';
import { makeEnClosingParagraph, makeEnHeading, makeEnListItem, makeEnOpeningParagraph, makeEnNounPhrase, makeEnParagraph, makeEnPredicatePhrase, makeEnSentence, makeEnTableCell, makeEnThinkingText } from '@/features/fake-lm/languages/en/languagePack';
import { makeJaClosingParagraph, makeJaHeading, makeJaListItem, makeJaOpeningParagraph, makeJaNounPhrase, makeJaParagraph, makeJaPredicatePhrase, makeJaSentence, makeJaTableCell, makeJaThinkingText } from '@/features/fake-lm/languages/ja/languagePack';
