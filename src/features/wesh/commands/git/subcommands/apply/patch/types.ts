...
export interface PatchOptions {
  ...
  backupAlways: boolean,
  backupMismatchMode: 'default' | 'enabled' | 'disabled',
  backupPrefix: string | undefined,
  backupBasenamePrefix: string | undefined,
  backupSuffix: string,
  backupSuffixExplicit: boolean,
  backupStyle: BackupStyle,
  backupStyleExplicit: boolean,
...
export interface ApplySectionResult {
  ...
  rejectionKind: 'failed' | 'ignored' | undefined,
  usedOffset: boolean,
  usedFuzz: boolean,
  diagnostics: string[],
