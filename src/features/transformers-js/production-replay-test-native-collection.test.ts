...
import { MODEL_SUPPORT_INVESTIGATION_MULTIMODAL_FIXTURE as image } from './model-support-investigation/fixtures/synthetic-multimodal-image';
...
describe('Production native collection through actual Comlink', () => {
  it.each([
    ...
    const { createProductionProviderGenerationCaptureOwner } = await import('./model-support-investigation/logic/production-provider-generation-capture-owner');
    ...
    try {
      ...
      const { createProductionProviderNativeEvidence, verifyProductionProviderNativeEvidenceSidecar } = await import('./model-support-investigation/logic/production-provider-native-evidence');
      ...
      const { createInitialInvestigationCheckpoint } = await import('./model-support-investigation/logic/investigation-recovery');
      const { createPartialModelSupportEvidence } = await import('./model-support-investigation/logic/create-partial-evidence');
  ...
  it('collects all immediate requests once with exact native stream grouping and no settlement repair', async () => {
    ...
    try {
      ...
      const nativeEvidenceModule = await import('./model-support-investigation/logic/production-provider-native-evidence');
      const { createInitialInvestigationCheckpoint } = await import('./model-support-investigation/logic/investigation-recovery');
      const { createPartialModelSupportEvidence } = await import('./model-support-investigation/logic/create-partial-evidence');
