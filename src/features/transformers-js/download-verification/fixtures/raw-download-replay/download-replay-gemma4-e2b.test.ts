...
it('Gemma 4 E2B freshly investigates metadata with absent Content-Length and 206 probes without model downloads', async () => {
...
it('Gemma 4 E2B stops candidate orchestration after shared processor metadata disappears without preparing another dtype', async () => {
  const modelId = 'onnx-community/gemma-4-E2B-it-ONNX';
  const revision = '9f4bef82ea6e296bc69f8a2f5939f73af81b07a6';
...
it('Gemma 4 E2B excludes a candidate with missing onnx/audio_encoder_q4f16.onnx_data before ORT without repairing it', async () => {
  const modelId = 'onnx-community/gemma-4-E2B-it-ONNX';
  const revision = '9f4bef82ea6e296bc69f8a2f5939f73af81b07a6';
...
it('Gemma 4 E2B rejects missing required processor_config.json during offline Load without repairing it', async () => {
  const modelId = 'onnx-community/gemma-4-E2B-it-ONNX';
  const revision = '9f4bef82ea6e296bc69f8a2f5939f73af81b07a6';
...
it('Gemma 4 E2B exact Download preserves its selected artifacts through fresh offline Load', async () => {
...
it('Gemma 4 E2B service Download reuses its committed candidate and cold-loads offline', async () => {
  const modelId = 'onnx-community/gemma-4-E2B-it-ONNX';
  const revision = '9f4bef82ea6e296bc69f8a2f5939f73af81b07a6';
  const expectedPaths = [
    'onnx/audio_encoder_q4f16.onnx',
