...
it('SmolLM2 135M distinguishes a config parse failure from transfer failure without exporting error content', async () => {
...
it('SmolLM2 135M freshly prepares metadata in the investigation Worker without reading existing OPFS', async () => {
  const modelId = 'HuggingFaceTB/SmolLM2-135M-Instruct';
  const revision = '12fd25f77366fa6b3b4b768ec3050bf629380bac';
  const h = await connectRawDownload({ modelId, revision, remoteRefs: new Map() });
  try {
...
it('SmolLM2 135M investigates missing Content-Length and 206 probes from an entirely empty profile', async () => {
  const modelId = 'HuggingFaceTB/SmolLM2-135M-Instruct';
  const revision = '12fd25f77366fa6b3b4b768ec3050bf629380bac';
  const h = await connectRawDownload({ modelId, revision, remoteRefs: new Map() });
  const originalTransport = h.network.getMockImplementation()!;
...
it('SmolLM2 135M completes fresh Download when metadata has no Content-Length and size probes return 206', async () => {
  const modelId = 'HuggingFaceTB/SmolLM2-135M-Instruct';
  const revision = '12fd25f77366fa6b3b4b768ec3050bf629380bac';
  const h = await connectRawDownload({ modelId, revision, remoteRefs: new Map() });
  const originalTransport = h.network.getMockImplementation()!;
...
it('SmolLM2 135M excludes a candidate with missing onnx/model_q4f16.onnx before ORT without repairing it', async () => {
  const modelId = 'HuggingFaceTB/SmolLM2-135M-Instruct';
  const revision = '12fd25f77366fa6b3b4b768ec3050bf629380bac';
...
it('SmolLM2 135M rejects missing required tokenizer.json during offline Load without repairing it', async () => {
  const modelId = 'HuggingFaceTB/SmolLM2-135M-Instruct';
  const revision = '12fd25f77366fa6b3b4b768ec3050bf629380bac';
...
it('SmolLM2 135M exact Download does not depend on an unprovided mutable main ref', async () => {
  const modelId = 'HuggingFaceTB/SmolLM2-135M-Instruct';
  const revision = '12fd25f77366fa6b3b4b768ec3050bf629380bac';
  const h = await connectRawDownload({ modelId, revision, remoteRefs: new Map() });
  try {
...
it('SmolLM2 135M preserves Download writes through fresh offline Load when fixture main points to the pinned revision', async () => {
  const modelId = 'HuggingFaceTB/SmolLM2-135M-Instruct';
  const revision = '12fd25f77366fa6b3b4b768ec3050bf629380bac';
...
it('SmolLM2 135M does not start model transfers when real tokenizer cache persistence fails', async () => {
  const modelId = 'HuggingFaceTB/SmolLM2-135M-Instruct';
  const revision = '12fd25f77366fa6b3b4b768ec3050bf629380bac';
  const h = await connectRawDownload({ modelId, revision, remoteRefs: new Map([['main', revision]]) });
...
it('SmolLM2 135M warm Download reuses completed model bytes without a second model transfer', async () => {
  const modelId = 'HuggingFaceTB/SmolLM2-135M-Instruct';
  const revision = '12fd25f77366fa6b3b4b768ec3050bf629380bac';
  const h = await connectRawDownload({ modelId, revision, remoteRefs: new Map([['main', revision]]) });
  try {
...
it('SmolLM2 135M cannot hide an ORT identity rejection behind Production fallback handling', async () => {
  const modelId = 'HuggingFaceTB/SmolLM2-135M-Instruct';
  const revision = '12fd25f77366fa6b3b4b768ec3050bf629380bac';
...
it('SmolLM2 135M service reuses a committed candidate beside an incomplete dtype and cold-loads without a revision hint', async () => {
  const modelId = 'HuggingFaceTB/SmolLM2-135M-Instruct';
  const revision = '12fd25f77366fa6b3b4b768ec3050bf629380bac';
  const h = await connectRawDownload({ modelId, revision, remoteRefs: new Map([['main', revision]]) });
  try {
...
it('SmolLM2 135M stops when a required artifact disappears after complete planning instead of falling back to complete q4', async () => {
  const modelId = 'HuggingFaceTB/SmolLM2-135M-Instruct';
  const revision = '12fd25f77366fa6b3b4b768ec3050bf629380bac';
  const h = await connectRawDownload({ modelId, revision, remoteRefs: new Map() });
  try {
...
it('SmolLM2 135M stops on required config loss after candidate planning without probing another dtype', async () => {
  const modelId = 'HuggingFaceTB/SmolLM2-135M-Instruct';
  const revision = '12fd25f77366fa6b3b4b768ec3050bf629380bac';
  const h = await connectRawDownload({ modelId, revision, remoteRefs: new Map() });
  try {
...
it('SmolLM2 135M forbids an unplanned external body after same-revision config changes between plan and Load', async () => {
  const modelId = 'HuggingFaceTB/SmolLM2-135M-Instruct';
  const revision = '12fd25f77366fa6b3b4b768ec3050bf629380bac';
  const h = await connectRawDownload({ modelId, revision, remoteRefs: new Map() });
  try {
...
it('SmolLM2 135M preserves a typed required metadata failure after revisionless presence planning succeeds', async () => {
  const modelId = 'HuggingFaceTB/SmolLM2-135M-Instruct';
  const revision = '12fd25f77366fa6b3b4b768ec3050bf629380bac';
  const h = await connectRawDownload({ modelId, revision, remoteRefs: new Map() });
  try {
