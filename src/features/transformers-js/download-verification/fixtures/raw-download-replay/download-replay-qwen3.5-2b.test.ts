...
it('Qwen3.5 2B freshly investigates metadata with absent Content-Length and 206 probes without model downloads', async () => {
...
it('Qwen3.5 2B excludes a candidate with missing onnx/decoder_model_merged_q4f16.onnx_data before ORT without repairing it', async () => {
  const modelId = 'onnx-community/Qwen3.5-2B-ONNX';
  const revision = 'b1fc7ca3afafcb8e4b13d29715a6b9ea5af1d1cb';
...
it('Qwen3.5 2B rejects missing required preprocessor_config.json during offline Load without repairing it', async () => {
  const modelId = 'onnx-community/Qwen3.5-2B-ONNX';
  const revision = 'b1fc7ca3afafcb8e4b13d29715a6b9ea5af1d1cb';
...
it('Qwen3.5 2B downloads only CausalLM decoder/embed and then passes real offline planning', async () => {
  const modelId = 'onnx-community/Qwen3.5-2B-ONNX';
  const revision = 'b1fc7ca3afafcb8e4b13d29715a6b9ea5af1d1cb';
...
it('Qwen3.5 2B service Download reuses its committed candidate and cold-loads offline', async () => {
  const modelId = 'onnx-community/Qwen3.5-2B-ONNX';
  const revision = 'b1fc7ca3afafcb8e4b13d29715a6b9ea5af1d1cb';
  const expectedPaths = [
    'onnx/decoder_model_merged_q4f16.onnx',
