...
import { readSyntheticModelBody } from '@/features/transformers-js/replay-models/support/download-synthetic-session-oracle';
...
describe('GPT-OSS 20B Download replay', () => {
  describe('metadata', () => {
  ...
  describe('candidate availability', () => {
    it('excludes a candidate with missing onnx/model_q4f16.onnx_data_6 before ORT without repairing it', async () => {
      const modelId = 'onnx-community/gpt-oss-20b-ONNX';
      const revision = '6dcc680ae66791268a1e4e96fc3bfd0e5d3662e7';
