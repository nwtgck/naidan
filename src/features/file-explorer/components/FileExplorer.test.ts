...
import type { ExplorerDirectory, ExplorerChild } from '../logic/explorer-directory';
import { LIST_ROW_HEIGHT } from '../logic/constants';
...
describe('FileExplorer.vue', () => {
  ...
  describe('readOnly directory', () => {
    class ReadOnlyMockExplorerDirectory extends MockExplorerDirectory {
      ...
      override async *children(): AsyncIterable<import('../logic/explorer-directory').ExplorerChild> {
