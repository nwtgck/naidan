...
<template>
  <div tw-class="flex items-center justify-between px-3 py-1.5 border-t border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-900/50 shrink-0 text-[10px] text-gray-400 dark:text-gray-500 select-none">
    <span>
    ...
    <span v-if="ctx.statusBarInfo.selectedCount > 0" tw-class="font-bold text-blue-500 dark:text-blue-400">
