...
<template>
  <main tw-class="h-full overflow-y-auto bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100" data-testid="image-generation-lab">
    <div tw-class="max-w-5xl mx-auto p-4 sm:p-8 space-y-6">
      <header tw-class="space-y-3">
        ...
        <p tw-class="text-sm border border-amber-300 dark:border-amber-800 rounded-xl p-4 bg-amber-50 dark:bg-amber-950">{{ lazyStrings.stableDiffusionCppBrowser__validation_limits() }}</p>
      ...
      <form @submit.prevent="generate" tw-class="space-y-5">
        ...
        <fieldset :disabled="formDisabled" tw-class="space-y-4">
          ...
          <label tw-class="block text-sm space-y-1"><span>{{ lazyStrings.stableDiffusionCppBrowser__negative_prompt() }}</span><textarea v-model="parameters.negativePrompt" rows="2" maxlength="4096" tw-class="block w-full rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 p-3" /></label>
          <div tw-class="grid grid-cols-2 sm:grid-cols-5 gap-3">
            <label tw-class="text-sm space-y-1"><span>{{ lazyStrings.stableDiffusionCppBrowser__width() }}</span><input v-model.number="parameters.width" type="number" min="128" max="2048" step="64" required tw-class="block w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-transparent p-2" /></label>
            <label tw-class="text-sm space-y-1"><span>{{ lazyStrings.stableDiffusionCppBrowser__height() }}</span><input v-model.number="parameters.height" type="number" min="128" max="2048" step="64" required tw-class="block w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-transparent p-2" /></label>
            <label tw-class="text-sm space-y-1"><span>{{ lazyStrings.stableDiffusionCppBrowser__steps() }}</span><input v-model.number="parameters.steps" type="number" min="1" max="100" step="1" required tw-class="block w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-transparent p-2" /></label>
            <label tw-class="text-sm space-y-1"><span>{{ lazyStrings.stableDiffusionCppBrowser__guidance() }}</span><input v-model.number="parameters.guidance" type="number" min="0" max="30" step="0.1" required tw-class="block w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-transparent p-2" /></label>
          ...
          <details tw-class="rounded-xl border border-gray-200 dark:border-gray-700 p-4 space-y-4">
            ...
            <div tw-class="grid sm:grid-cols-2 gap-4">
              ...
              <label tw-class="text-sm space-y-1"><span>{{ lazyStrings.stableDiffusionCppBrowser__distilled_guidance() }}</span><input v-model.number="parameters.distilledGuidance" type="number" min="0" max="30" step="0.1" required tw-class="block w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-transparent p-2" /></label>
              <label tw-class="text-sm space-y-1"><span>{{ lazyStrings.stableDiffusionCppBrowser__conditioning_cache() }}</span><input v-model.number="parameters.conditioningCacheSize" type="number" min="0" max="32" step="1" required tw-class="block w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-transparent p-2" /></label>
              ...
              <label tw-class="text-sm space-y-1"><span>{{ lazyStrings.stableDiffusionCppBrowser__vae_tile_size() }}</span><input v-model.number="parameters.vaeTileSize" type="number" min="16" max="256" step="8" required tw-class="block w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-transparent p-2" /></label>
