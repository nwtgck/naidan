...
import {
  formatBinaryRange,
  formatBytesAsHex,
} from '@/features/debug-encrypted-opfs/logic/binary-hex';
import type { EncryptedOpfsDecodedBinaryFieldView } from '@/features/debug-encrypted-opfs/worker/types';

defineProps<{
  readonly fields: readonly EncryptedOpfsDecodedBinaryFieldView[];
}>();
