...
export class GarbageCollectionMarkCursor {
  #abortReason: GarbageCollectionMarkAbortReason | undefined;
  #budget: MaintenanceCycleBudget;
  #candidateBatch: CandidateSegmentBatch;
  #completedMemo: BoundedCompletedReferenceMemo;
  #currentPath = new Set<string>();
  #observedRoles = new Map<string, MaintenanceTraversalItem["pageRole"]>();
  #phase: "aborted_without_deletion" | "batch_complete" | "marking" = "marking";
  ...
  #recordRoleOrThrow({ item }: { item: MaintenanceTraversalItem }): void {
  ...
  #abort({ reason }: { reason: GarbageCollectionMarkAbortReason }): GarbageCollectionMarkSliceResult {
