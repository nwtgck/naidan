...
export class StreamingFileImport {
  private readonly extentMutationBatchLimit: number;
  private readonly port: FileContentMutationPort;
  private extentRoot: HomeRecordReference | undefined;
  private nextOffset = 0n;
  private stateValue: StreamingFileImportState = "active";
  ...
  private async ensureExtentRoot(): Promise<HomeRecordReference> {
