...
vi.mock('lucide-vue-next', () => ({
  ...
  RotateCwIcon: { template: '<span>RotateCw</span>' },
  FlipHorizontalIcon: { template: '<span>FlipHorizontal</span>' },
  FlipVerticalIcon: { template: '<span>FlipVertical</span>' },
  ...
  CropIcon: { template: '<span>Crop</span>' },
  EraserIcon: { template: '<span>Eraser</span>' },
  SquareIcon: { template: '<span>Square</span>' },
  CircleIcon: { template: '<span>Circle</span>' },
  LinkIcon: { template: '<span>Link</span>' },
  Link2OffIcon: { template: '<span>Link2Off</span>' },
  PanelRightIcon: { template: '<span>PanelRight</span>' },
  ZoomInIcon: { template: '<span>ZoomIn</span>' },
  ZoomOutIcon: { template: '<span>ZoomOut</span>' },
  SearchIcon: { template: '<span>Search</span>' },
  PipetteIcon: { template: '<span>Pipette</span>' },
}));
