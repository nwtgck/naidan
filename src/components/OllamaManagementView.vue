...
<template>
  <section
    tw-class="space-y-5 border-t border-gray-100 pt-6 dark:border-gray-800"
    aria-labelledby="ollama-runtime-heading"
    data-testid="ollama-management-view"
  >
    <div tw-class="flex items-center gap-2 border-b border-gray-100 pb-3 dark:border-gray-800">
      <ServerCogIcon tw-class="h-5 w-5 text-blue-500" />
      <h2 id="ollama-runtime-heading" tw-class="text-lg font-bold tracking-tight text-gray-800 dark:text-white">
        {{ lazyStrings.OllamaManagementView__ollama_runtime() }}
      </h2>
    </div>

    <p tw-class="ml-1 text-[11px] font-medium leading-relaxed text-gray-400">
