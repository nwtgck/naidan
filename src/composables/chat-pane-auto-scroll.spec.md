# Chat Pane Auto-Scroll Spec

## Rules

1. When a chat view opens, the chat pane positions itself immediately without animation.
...
4. After a new user message starts a turn, the chat pane becomes eligible for one assistant auto-scroll.
