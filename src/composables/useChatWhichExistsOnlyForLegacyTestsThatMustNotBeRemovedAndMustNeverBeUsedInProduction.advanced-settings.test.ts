...
describe('useChatWhichExistsOnlyForLegacyTestsThatMustNotBeRemovedAndMustNeverBeUsedInProduction Advanced Settings Resolution', () => {
  ...
  describe('Chat Independence', () => {
    const { TEST_ONLY: { __testOnlySetCurrentChat } } = useChatWhichExistsOnlyForLegacyTestsThatMustNotBeRemovedAndMustNeverBeUsedInProduction();
...
describe('Chat Specific Overrides - Endpoint Persistence', () => {
  ...
  const { currentChat, createNewChat, openChat, updateChatSettings, renameChat } = useChatWhichExistsOnlyForLegacyTestsThatMustNotBeRemovedAndMustNeverBeUsedInProduction();
