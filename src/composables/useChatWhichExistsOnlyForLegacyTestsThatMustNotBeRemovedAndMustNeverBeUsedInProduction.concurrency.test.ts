...
describe('useChatWhichExistsOnlyForLegacyTestsThatMustNotBeRemovedAndMustNeverBeUsedInProduction Concurrency & Stale State Protection', () => {
  ...
  it('should allow multiple chats to stream concurrently', async () => {
    const { createNewChat, sendMessage } = useChatWhichExistsOnlyForLegacyTestsThatMustNotBeRemovedAndMustNeverBeUsedInProduction();
  ...
  it('should not jump out of a group if moved while generating in background', async () => {
    const { createNewChat, currentChat, sendMessage } = useChatWhichExistsOnlyForLegacyTestsThatMustNotBeRemovedAndMustNeverBeUsedInProduction();
  ...
  it('should not overwrite manual renames if renamed while generating in background', async () => {
    const { createNewChat, sendMessage, renameChat } = useChatWhichExistsOnlyForLegacyTestsThatMustNotBeRemovedAndMustNeverBeUsedInProduction();
  ...
  it('should not resurrect a deleted chat when background generation finishes', async () => {
    const { createNewChat, currentChat, sendMessage, deleteChat } = useChatWhichExistsOnlyForLegacyTestsThatMustNotBeRemovedAndMustNeverBeUsedInProduction();
  ...
  it('should not resurrect chats after deleteAllChats', async () => {
    const { createNewChat, currentChat, sendMessage, deleteAllChats } = useChatWhichExistsOnlyForLegacyTestsThatMustNotBeRemovedAndMustNeverBeUsedInProduction();
  ...
  it('should isolate AbortController between concurrent generations', async () => {
    const { createNewChat, currentChat, sendMessage, abortChat } = useChatWhichExistsOnlyForLegacyTestsThatMustNotBeRemovedAndMustNeverBeUsedInProduction();
  ...
  it('should allow creating and using a new chat while another is streaming', async () => {
    const chatStore = useChatWhichExistsOnlyForLegacyTestsThatMustNotBeRemovedAndMustNeverBeUsedInProduction();
    const { createNewChat, sendMessage, TEST_ONLY } = chatStore;
